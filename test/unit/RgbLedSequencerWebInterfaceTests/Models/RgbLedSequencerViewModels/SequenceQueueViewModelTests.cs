// <copyright file="SequenceQueueViewModelTests.cs" company="natsnudasoft">
...
namespace Natsnudasoft.RgbLedSequencerWebInterfaceTests.Models.RgbLedSequencerViewModels
{
    using System;
    ...
    using Xunit;
    using SutAlias = RgbLedSequencerWebInterface.Models.RgbLedSequencerViewModels.SequenceQueueViewModel;

    public class SequenceQueueViewModelTests
    {
