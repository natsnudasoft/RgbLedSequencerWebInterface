// <copyright file="ColorStringItemTests.cs" company="natsnudasoft">
...
namespace Natsnudasoft.RgbLedSequencerWebInterfaceTests.Models
{
    ...
    using Xunit;
    using SutAlias = RgbLedSequencerWebInterface.Models.ColorStringItem;

    public class ColorStringItemTests
    {
